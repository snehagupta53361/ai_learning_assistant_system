...
/*
 * Generate falshcards from text
 * @param {string} text -- Document text
 * @param { number } count -- Number of flashcards to generateFlashcards
 * @returns { PromiseArray< {question: string, answer: string, difficulty: string} >>}
 */
...
/* 
* Explain a specific explainConcept
...
export const explainConcept = async (concept, context) => {
  ...
  Provide a clear, educations explanation that's easy to understand.
  Include examples if relevant
  Try to explain the complex concept with real world examples if possible.
