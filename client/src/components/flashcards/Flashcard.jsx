  ...
  return (
    <div className="relative w-full h-72" style={{ perspective: "1000px" }}>
      ...
      >
            ...
            <button
              ...
              className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200 ${
                flashcard.isStarred
                  ...
                  : "bg-slate-100 text-slate-400 hover:bg-slate-200 hover:text-amber-500/25"
              }`}
            >
              <Star
                className="w-4 h-4"
        ...
        <div
          className="absolute inset-0 w-full h-full bg-linear-to-br from-emerald-500 to-teal-500 border-2 border-emerald-400/60 rounded-2xl shadow-sm shadow-emerald-500/30 p-9 flex flex-col justify-between items-center"
          style={{
            backfaceVisibility: "hidden",
            WebkitBackfaceVisibility: "hidden",
        ...
        >
          ...
          {/* Flip indicator */}
          <div className="flex items-center justify-center gap-2 text-xs text-white/79 font-medium">
            <RotateCcw className="w-3.5 h-3.5" strokeWidth={2} />
