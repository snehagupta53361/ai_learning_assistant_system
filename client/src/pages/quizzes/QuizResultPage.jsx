...
const QuizResultPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {/* Score card */}
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-5 mb-8">
            ...
            >
              <div className="flex items-start justify-between gap-4 mb-3">
                <div className="flex-1">
                  <div className="inline-flex items-center justify-center bg-linear-to-br from-slate-100 to-slate-100 border-2 border-slate-200 px-3 py-1 rounded-lg mb-3">
                    <span className="text-xs font-semibold text-slate-700">
                      Question {index + 1}
                    </span>
                  </div>
                  <h4 className="text-base font-semibold text-slate-700 leading-relaxed">
                    ...
                    >
                      <div className="flex justify-between items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          {isCorrectOption && (
                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-emerald-100 border border-emerald-300 rounded-lg text-emerald-700 text-xs font-semibold">
                              <CheckCircle2
                                className="w-3 h- "
                                strokeWidth={2.5}
                              />
                          ...
                          {isWrongAnswer && (
                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-rose-100 border border-rose-300 rounded-lg text-rose-700 text-xs font-semibold">
